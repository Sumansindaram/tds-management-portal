                ...
                {TRANSPORT_GROUPS.map(group => {
                  ...
                  return (
                    <Button
                      ...
                      className={`h-auto min-h-[3rem] flex-col items-start justify-center px-3 py-2 ${hasFiles ? 'bg-primary text-primary-foreground hover:bg-primary/90' : "bg-muted text-card-foreground"}`}
                      disabled={!hasFiles}
                       onClick={() => {
                         if (hasFiles && entry) {
